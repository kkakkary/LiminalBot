...
var _CoreListener = class _CoreListener extends Listener_cjs.Listener {
  constructor(context) {
    super(context, { event: Events_cjs.Events.PossibleChatInputCommand });
  }
  run(interaction) {
    ...
    if (!command) {
      client.emit(Events_cjs.Events.UnknownChatInputCommand, {
        interaction,
    ...
    if (!command.chatInputRun) {
      client.emit(Events_cjs.Events.CommandDoesNotHaveChatInputCommandHandler, {
        command,
        interaction,
        context: { commandId: interaction.commandId, commandName: interaction.commandName }
      });
    ...
    client.emit(Events_cjs.Events.PreChatInputCommandRun, {
      command,
      context: { commandId: interaction.commandId, commandName: interaction.commandName },
      interaction
    });
...
//# sourceMappingURL=CorePossibleChatInputCommand.cjs.map
//# sourceMappingURL=CorePossibleChatInputCommand.cjs.map