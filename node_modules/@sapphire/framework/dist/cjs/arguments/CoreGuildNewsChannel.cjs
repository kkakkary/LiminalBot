...
var guildNewsChannel_cjs = require('../lib/resolvers/guildNewsChannel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    ...
    const resolved = guildNewsChannel_cjs.resolveGuildNewsChannel(parameter, guild);
...
//# sourceMappingURL=CoreGuildNewsChannel.cjs.map
//# sourceMappingURL=CoreGuildNewsChannel.cjs.map