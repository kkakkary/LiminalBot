...
var dmChannel_cjs = require('../lib/resolvers/dmChannel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    const resolved = dmChannel_cjs.resolveDMChannel(parameter, context.message);
...
//# sourceMappingURL=CoreDMChannel.cjs.map
//# sourceMappingURL=CoreDMChannel.cjs.map