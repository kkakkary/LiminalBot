...
var guildThreadChannel_cjs = require('../lib/resolvers/guildThreadChannel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    ...
    const resolved = guildThreadChannel_cjs.resolveGuildThreadChannel(parameter, guild);
...
//# sourceMappingURL=CoreGuildThreadChannel.cjs.map
//# sourceMappingURL=CoreGuildThreadChannel.cjs.map