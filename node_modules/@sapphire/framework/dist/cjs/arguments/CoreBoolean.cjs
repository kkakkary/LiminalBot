...
var boolean_cjs = require('../lib/resolvers/boolean.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    const resolved = boolean_cjs.resolveBoolean(parameter, { truths: context.truths, falses: context.falses });
...
//# sourceMappingURL=CoreBoolean.cjs.map
//# sourceMappingURL=CoreBoolean.cjs.map