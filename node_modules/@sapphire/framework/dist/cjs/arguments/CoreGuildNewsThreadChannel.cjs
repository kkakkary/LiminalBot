...
var guildNewsThreadChannel_cjs = require('../lib/resolvers/guildNewsThreadChannel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    ...
    const resolved = guildNewsThreadChannel_cjs.resolveGuildNewsThreadChannel(parameter, guild);
...
//# sourceMappingURL=CoreGuildNewsThreadChannel.cjs.map
//# sourceMappingURL=CoreGuildNewsThreadChannel.cjs.map