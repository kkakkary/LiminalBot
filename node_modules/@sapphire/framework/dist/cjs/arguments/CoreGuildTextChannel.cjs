...
var guildTextChannel_cjs = require('../lib/resolvers/guildTextChannel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    ...
    const resolved = guildTextChannel_cjs.resolveGuildTextChannel(parameter, guild);
...
//# sourceMappingURL=CoreGuildTextChannel.cjs.map
//# sourceMappingURL=CoreGuildTextChannel.cjs.map