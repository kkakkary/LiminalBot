...
var guildStageVoiceChannel_cjs = require('../lib/resolvers/guildStageVoiceChannel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    ...
    const resolved = guildStageVoiceChannel_cjs.resolveGuildStageVoiceChannel(parameter, guild);
...
//# sourceMappingURL=CoreGuildStageVoiceChannel.cjs.map
//# sourceMappingURL=CoreGuildStageVoiceChannel.cjs.map