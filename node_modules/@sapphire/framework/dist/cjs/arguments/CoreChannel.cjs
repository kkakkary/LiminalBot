...
var channel_cjs = require('../lib/resolvers/channel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    const resolved = channel_cjs.resolveChannel(parameter, context.message);
...
//# sourceMappingURL=CoreChannel.cjs.map
//# sourceMappingURL=CoreChannel.cjs.map