...
var guildPrivateThreadChannel_cjs = require('../lib/resolvers/guildPrivateThreadChannel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    ...
    const resolved = guildPrivateThreadChannel_cjs.resolveGuildPrivateThreadChannel(parameter, guild);
