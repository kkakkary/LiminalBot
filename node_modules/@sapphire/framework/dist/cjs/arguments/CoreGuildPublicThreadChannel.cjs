...
var guildPublicThreadChannel_cjs = require('../lib/resolvers/guildPublicThreadChannel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    ...
    const resolved = guildPublicThreadChannel_cjs.resolveGuildPublicThreadChannel(parameter, guild);
...
//# sourceMappingURL=CoreGuildPublicThreadChannel.cjs.map
//# sourceMappingURL=CoreGuildPublicThreadChannel.cjs.map