...
var guildVoiceChannel_cjs = require('../lib/resolvers/guildVoiceChannel.cjs');
...
var _CoreArgument = class _CoreArgument extends Argument_cjs.Argument {
  ...
  run(parameter, context) {
    ...
    const resolved = guildVoiceChannel_cjs.resolveGuildVoiceChannel(parameter, guild);
...
//# sourceMappingURL=CoreGuildVoiceChannel.cjs.map
//# sourceMappingURL=CoreGuildVoiceChannel.cjs.map