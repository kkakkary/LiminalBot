...
var _CorePrecondition = class _CorePrecondition extends Precondition_cjs.AllFlowsPrecondition {
  ...
  async chatInputRun(interaction) {
    ...
    return channel.type === discord_js.ChannelType.AnnouncementThread ? this.ok() : this.makeSharedError();
  }
  ...
  makeSharedError() {
    return this.error({
      identifier: Identifiers_cjs.Identifiers.PreconditionGuildNewsThreadOnly,
