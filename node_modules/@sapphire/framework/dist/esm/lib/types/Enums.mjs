...
var CommandPreConditions = /* @__PURE__ */ ((CommandPreConditions2) => {
  ...
  CommandPreConditions2["RunIn"] = "RunIn";
...
export { BucketScope, CommandOptionsRunTypeEnum, CommandPreConditions, CooldownLevel, InternalRegistryAPIType, PluginHook, RegisterBehavior };
