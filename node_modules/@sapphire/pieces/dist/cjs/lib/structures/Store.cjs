...
var _Store = class _Store extends (_b = collection.Collection, _a = constants_cjs.ManuallyRegisteredPiecesSymbol, _b) {
  /**
  ...
  resolve(name) {
    if (typeof name === "string") {
      ...
      if (typeof result === "undefined") throw new LoaderError_cjs.LoaderError(LoaderError_cjs.LoaderErrorType.UnloadedPiece, `The piece '${name}' does not exist.`);
      return result;
    }
