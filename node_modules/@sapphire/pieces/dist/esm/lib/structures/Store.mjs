...
import { LoaderError, LoaderErrorType } from '../errors/LoaderError.mjs';
import { resolvePath } from '../internal/Path.mjs';
import { ManuallyRegisteredPiecesSymbol, VirtualPath } from '../internal/constants.mjs';
import { container } from '../shared/Container.mjs';
import { LoaderStrategy } from '../strategies/LoaderStrategy.mjs';
...
var _Store = class _Store extends (_b = Collection, _a = ManuallyRegisteredPiecesSymbol, _b) {
  ...
  async loadPiece(entry) {
    ...
    if (!classExtends(entry.piece, this.Constructor)) {
